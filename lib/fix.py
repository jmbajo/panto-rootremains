...
def _load(zip_file, map_location, pickle_module, pickle_file='data.pkl', overall_storage=None, **pickle_load_args):
    ...
    class UnpicklerWrapper(pickle_module.Unpickler):  # type: ignore[name-defined]
        ...
        def find_class(self, mod_name, name):
            ...
            # print(mod_name, name)
            if name == 'HorizontalFlip' or name == 'VerticalFlip':
                return super().find_class('albumentations.augmentations.geometric.transforms', name)
            elif name == 'GaussianBlur':
                return super().find_class('albumentations.augmentations.blur.transforms', name)
            else:
                return super().find_class(mod_name, name)
...
def load_learner(fname, cpu=True, pickle_module=pickle):
    ...
    try: res = load(fname, map_location=map_loc, pickle_module=pickle_module)
